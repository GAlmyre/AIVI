...
plot 'stats.txt' using 1:2 with lines title 'MSE', 'stats.txt' using 1:3 with lines title 'PSNR', 'stats.txt' using 1:4 with lines title 'ENT', 'stats.txt' using 1:5 with lines title 'ENTe'
